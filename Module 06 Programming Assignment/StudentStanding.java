...
public class StudentStanding {
    public static void main(String[] args) {
        ...
        Path goodFile = Paths.get(".\\Module 06 Programming assignment\\inGoodStandingFile.txt");
        Path probationFile = Paths.get(".\\Module 06 Programming assignment\\inBadStandingFile.txt");
