...
public class CreateFilesBasedOnState {
    public static  void main(String[] args){
        ...
        Path inStateFile = Paths.get("Chapter 11 (you do it)\\InStateCusts.txt");
        Path outOfStateFile = Paths.get("Chapter 11 (you do it)\\OutStateCusts.txt");
