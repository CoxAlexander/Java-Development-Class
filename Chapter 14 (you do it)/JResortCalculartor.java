...
import javax.swing.*;
public class JResortCalculartor extends JFrame implements ItemListener{
    ...
    JLabel optionExplainLabel2 = new JLabel("Checl the options you want.");
    public JResortCalculartor() {
    ...
    public static void main(String[] args) {
        JResortCalculartor aFrame = new JResortCalculartor();
        final int WIDTH = 300;
